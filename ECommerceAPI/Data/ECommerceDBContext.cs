    ...
    public class ECommerceDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TrackingDetail>().HasData(
                new TrackingDetail { Id = 1, OrderId = 1, Carrier = "FedEx", EstimatedDeliveryDate = DateTime.Now.AddDays(7), TrackingNumber = "123456789" },
                new TrackingDetail { Id = 2, OrderId = 2, Carrier = "FedEx", EstimatedDeliveryDate = DateTime.Now.AddDays(5), TrackingNumber = "123789456" }
            );
        }
